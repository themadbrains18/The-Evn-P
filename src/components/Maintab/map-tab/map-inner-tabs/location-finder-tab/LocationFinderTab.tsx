...
const LocationFinderTab = () => {
    ...
    return (
        <>
            ...
            <Typography className={classes.map_location_heading} component={"h4"} sx={{ fontSize: "14px", lineHeight: "16px", fontWeight: "500", color: "#000000", marginBottom: "10px", }} >Location Search</Typography>
            <Paper
                component="form"
