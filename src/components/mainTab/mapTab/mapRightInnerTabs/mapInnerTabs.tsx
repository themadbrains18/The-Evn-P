...
const MapInnerTabs = () => {
  ...
  return (
    <>
      <Box sx={{ pt: 3.375, px: { xl: 3, xs: 1.5 } }}>
        <TabsUnstyled defaultValue={0} >
          {/* ===  Tab List === */}
          <TabsList>

            {/* Map Layer Tab */}
            <Tooltip title="Map Layers" arrow  placement="top">
              <Tab>
            ...
            {/* Area Map Tab */}
            <Tooltip title="Area Map" arrow  placement="top">
              <Tab>
                <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Location Finder Tab */}
            <Tooltip title="Location Finder" arrow  placement="top">
              <Tab>
                <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Basic Stastics Tab */}
            <Tooltip title="Basic Stastics" arrow  placement="top">
              <Tab>
                <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
