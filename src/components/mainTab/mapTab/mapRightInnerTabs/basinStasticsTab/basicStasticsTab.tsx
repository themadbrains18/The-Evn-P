            ...
            <Box sx={{ paddingBottom: "80px", overflow: "hidden" }}>
                <Box>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                        <Box>
                            <Button variant="outlined" sx={{ tarnsition: "0.3s", "&:hover": { background: "#0F75BC", color: "#fff", "& svg path": { fill: "#fff" } }, color: "#0F75BC", lineHeight: "11px", fontSize: "10px", height: "100%", fontWeight: "700", padding: "8px 11px" }}>
                                <Box component={"span"}>
                        ...
                        <Box >
                            <Button variant="outlined" sx={{ tarnsition: "0.3s", "&:hover": { background: "#0F75BC", color: "#fff", "& svg path": { stroke: "#fff" } }, color: "#0F75BC", lineHeight: "11px", fontSize: "10px", height: "100%", fontWeight: "700", padding: "8px 11px", mr: "6px" }}>
                                <Box component={"span"}>
                            ...
                            <Button variant="outlined" sx={{ tarnsition: "0.3s", "&:hover": { background: "#0F75BC", color: "#fff", "& svg path": { stroke: "#fff" } }, color: "#0F75BC", lineHeight: "11px", fontSize: "10px", height: "100%", fontWeight: "700", padding: "8px 11px" }}>
                                <Box component={"span"}>
                                    <svg width={18} height={19} viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 12.5V13.25C3 13.8467 3.23705 14.419 3.65901 14.841C4.08097 15.2629 4.65326 15.5 5.25 15.5H12.75C13.3467 15.5 13.919 15.2629 14.341 14.841C14.7629 14.419 15 13.8467 15 13.25V12.5M12 9.5L9 12.5M9 12.5L6 9.5M9 12.5V3.5" stroke="#0F75BC" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
