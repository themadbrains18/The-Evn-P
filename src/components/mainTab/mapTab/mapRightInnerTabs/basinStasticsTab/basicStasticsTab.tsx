            ...
            <Box sx={{ paddingBottom: "80px", overflow: "hidden" }}>
                <Box>
                    ...
                    <Box sx={{ display: "flex",gap:"5px", justifyContent: "space-between",alignItems:"center" }}>
                        <Box>
                            <Button variant="outlined" sx={{ padding:{lg:"8px 11px",xs:"8px 10px"}  }}>
                        ...
                        <Box sx={{display:"flex",gap:"5px"}}>
                            {
                                BasinTabBtn.map((value,index) => {
                                    return (
                                        <Button key={index} variant="outlined" sx={{ "&:hover": { "& svg path": { stroke: "#fff", fill: "none" } }, padding:{lg:"8px 11px",xs:"8px 10px"}  }}>
                                            {value.BtnIcon}
                                            {value.BtnNmae}
                                        </Button>
                                    )
                ...
                <Box to="/dashboard" component={Link} sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: { lg: "25px", xs: "10px" }, padding: "18px 0", borderTop: " 1px solid #0000001f", position: "fixed", right: "0px", bottom: "0", width: { xl: "373px", lg: "304px", xs: "254px" }, backgroundColor: "background.default" }}>
