...
const DonutChart = () => {
    return (
        <>
            <Box sx={{ mt: 3 }}>
                <Typography component="h5" sx={{ fontWeight: "600", fontSize: { lg: "18px", xs: "16px" }, lineHeight: "20px", color: "common.black" }}>
                ...
                <Box sx={{ textAlign: "center", mt: 2.5, display: "grid", gridTemplateColumns: { lg: "repeat(3,33.333%)", xs: "repeat(2,50%)" }, rowGap: "10px!important", gap: "5px" }}>
                    <Box sx={{ display: "grid", alignItems: "center", gridTemplateColumns: "auto 1fr", gap: { lg: "12px", xs: "5px" } }}>
                        ...
                        <Typography component="h5" sx={{ fontWeight: "500", fontSize: "10px", lineHeight: "1", color: "common.black", textAlign: "left", opacity: "0.4" }}>
                            Change later
                        </Typography>
                    </Box>
                    <Box sx={{ display: "grid", alignItems: "center", gridTemplateColumns: "auto 1fr", gap: { lg: "12px", xs: "5px" } }}>
