                            ...
                            <Box key={index} >
                                {/* Map View */}
                                {
                                    ...
                                    <Button variant="text" sx={{ alignItems: "center" }}>
                                        ...
                                        <Typography component="span" sx={{ fontWeight: "400", fontSize: { lg: 16, xs: 14 }, lineHeight: "18px", color: "secondary.light", textTransform: 'capitalize', ml: 1 }}>
                                            Map View
                                        </Typography>
                                    </Button>
                                }
            ...
            </Box>
            {
                props.blockInfo ?
                    <Box sx={{ backgroundColor: "background.paper", p: "14px 33px 30px 13px", boxShadow: "0px 0px 10px #F3F4F6", mt: 3.75 }}>
                        ...
                        <Divider sx={{ borderBottomWidth: "2px", my: "16px", borderColor: "divider", ml: "-13px", width: "100%" }} />
                        <Typography component="p" sx={{ fontSize: { lg: 14, xs: 12 }, textAlign: "justify", color: "text.secondary", lineHeight: "23px" }}>
                            {/* Tab Info */}
                            {props.tabInfo}
                        </Typography>
                    </Box>
