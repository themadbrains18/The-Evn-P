    ...
    return (
        <>
            <Box sx={{ display: "grid", placeItems: "center", height: "100%", minHeight: "calc(100vh - 84px) " }}>
                <Box sx={{ maxWidth: "529px", width: "100%", height: "512px", p: "50px 30px", background: "#FFFFFF", boxShadow: " 0px 4px 10px #F3F4F6", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", gap: "35px" }}>
