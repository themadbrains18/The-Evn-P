        ...
        <>
            <Box sx={{ "& form": { maxWidth: "529px", width: "100%", p: "50px 30px", background: "#FFFFFF", boxShadow: " 0px 4px 10px #F3F4F6" }, display: "grid", placeItems: "center", height: "100%", minHeight: "calc(100vh - 84px) " }}>
                <form onSubmit={props.OnSubmitUpdatePwsd} action="">
                    ...
                    <Box sx={{ textAlign: "center", mt: "26px", "& button": { display: "flex", gap: "11px", justifyContent: "center", maxWidth: "fit-content", width: "100%", m: "0 auto", alignItems: "center", color: "#0F75BC", fontWeight: "600", fontSize: { lg: "14px", xs: "14px" }, lineHeight: "16px" } }}>
